...
export function Svg(props: SvgProps) {
  ...
  const style = props.colorStroke ? { stroke: color, fill: "none" } : { fill: color };
  return (
...
export function IconAddPerson(props: IconSvgProps) {
  // Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com
  // License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.
  return <Svg {...props} height={props.height ?? 20} width={props.width ?? 20} viewBox="0 0 640 512">
...
export function IconCat(props: IconSvgProps) {
  ...
  return <Svg {...props} height={props.height ?? 20} width={props.width ?? 20} viewBox="0 0 75 60">
...
export function IconQuestion(props: IconSvgProps) {
  ...
  // Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com
  // License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.
  return <Svg {...props} height={props.height ?? 16} width={props.width ?? 16} viewBox="0 0 512 512">
...
export function IconLockInline(props: IconSvgProps) {
  return <IconLock {...props} className={`icon-lock-inline ${props.className}`} />;
}

export function IconLockOpenInline(props: IconSvgProps) {
  return <IconLockOpen {...props} className={`icon-lock-inline ${props.className}`} />;
}

export function IconRecycle(props: IconSvgProps) {
  // Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com
  // License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.
  return <Svg {...props} height={props.height ?? 20} width={props.width ?? 20} viewBox="0 0 512 512">
...
export function IconRecycleInline() {
  return <IconRecycle width="0.9em" height="0.9em" className="heart-recycle-inline" />;
}
